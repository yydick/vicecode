 ...
 *
 * 脚手架：VICECODE_PLUGINS_DIR 指向 tmp 空目录，保证命令清单只有系统 26 项（含 AI 组、无插件组），
...
check($app->palette->totalCount() === 26, '命令清单为系统 26 项（含 AI 组 9 项、无插件组，实际 ' . $app->palette->totalCount() . '）');
check($app->palette->matchCount() === 26, '空过滤时展示全部 26 项');
